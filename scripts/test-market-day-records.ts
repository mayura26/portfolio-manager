...

{
  ...
  assert.equal(records.bestDay?.contributors[0].contributionBase.toString(), "100");
  assert.equal(records.bestDay?.contributors[0].sharePercent?.toFixed(2), "66.67");
  assert.equal(records.bestDay?.contributors[1].symbol, "BBB");
  assert.equal(records.bestDay?.contributors[1].contributionBase.toString(), "-50");
}

{
  ...
  assert.equal(records.worstDay?.contributors[0].changePercent?.toString(), "-10");
}
}
